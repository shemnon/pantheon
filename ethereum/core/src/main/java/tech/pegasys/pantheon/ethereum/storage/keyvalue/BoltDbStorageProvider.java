...
import tech.pegasys.pantheon.services.kvstore.BoltDBKeyValueStorage;
...
public class BoltDbStorageProvider {
  ...
  public static StorageProvider create(
    ...
    final KeyValueStorage kv = BoltDBKeyValueStorage.create(rocksDbConfiguration, metricsSystem);
