...
import tech.pegasys.pantheon.services.kvstore.LevelDbKeyValueStorage;

import java.io.IOException;
import java.nio.file.Files;
import java.nio.file.Path;

public class LevelDbStorageProvider {

  public static StorageProvider create(final Path databaseDir, final MetricsSystem metricsSystem)
      throws IOException {
    final KeyValueStorage kv =
        LevelDbKeyValueStorage.create(Files.createDirectories(databaseDir), metricsSystem);
