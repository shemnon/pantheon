...
public class PeerDiscoveryTimestampsTest {
  ...
  public void lastSeenAndFirstDiscoveredTimestampsUpdatedOnMessage() {
    ...
    DiscoveryPeer p = controller.discoveredPeers().iterator().next();
    ...
    p = controller.discoveredPeers().iterator().next();
  ...
  public void lastContactedTimestampUpdatedOnOutboundMessage() {
    ...
    DiscoveryPeer peer = agent.discoveredPeers().iterator().next();
    ...
    peer = agent.discoveredPeers().iterator().next();
