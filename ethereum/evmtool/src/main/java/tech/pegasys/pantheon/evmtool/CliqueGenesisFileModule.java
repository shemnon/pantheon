...
public class CliqueGenesisFileModule extends GenesisFileModule {

  SECP256K1.KeyPair nodeKeys;

  public CliqueGenesisFileModule(final File genesisFile) throws IOException {
    super(genesisFile);
  }

  public CliqueGenesisFileModule(final String genesisConfig) {
    super(genesisConfig);
  }

  @Override
  ProtocolSchedule<?> provideProtocolSchedule(final GenesisConfigOptions configOptions) {
    // guice can handle this magic
    return CliqueProtocolSchedule.create(configOptions, nodeKeys);
  }
