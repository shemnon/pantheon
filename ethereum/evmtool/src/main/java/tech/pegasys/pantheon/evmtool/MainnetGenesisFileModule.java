...
public class MainnetGenesisFileModule extends GenesisFileModule {

  public MainnetGenesisFileModule(final File genesisFile) throws IOException {
    super(genesisFile);
  }

  public MainnetGenesisFileModule(final String genesisConfig) {
    super(genesisConfig);
  }
