...
public class HaloDbKeyValueStorage implements KeyValueStorage, Closeable {
  ...
  private HaloDbKeyValueStorage(
    ...
    try {
      ...
      options.setMaxFileSize(haloDbConfiguration.getMaxFileSize());
      ...
      options.setFlushDataSizeBytes(haloDbConfiguration.getFlushDataSizeBytes());
      ...
      options.setCompactionThresholdPerFile(haloDbConfiguration.getCompationThresholdPerFile());
      ...
      options.setCompactionJobRate(haloDbConfiguration.getCompactionJobRate());
      ...
      options.setNumberOfRecords(haloDbConfiguration.getNumberOfRecords());
      ...
      options.setCleanUpTombstonesDuringOpen(haloDbConfiguration.isCleanUpTombstonesDuringOpen());
      ...
      options.setCleanUpInMemoryIndexOnClose(haloDbConfiguration.isCleanUpInMemoryIndexOnClose());

      // ** settings for memory pool **
      options.setUseMemoryPool(haloDbConfiguration.isUseMemoryPool());
      ...
      options.setMemoryPoolChunkSize(haloDbConfiguration.getMemoryPoolChunkSize());
      ...
      options.setFixedKeySize(haloDbConfiguration.getFixedKeySize());

      // The directory will be created if it doesn't exist and all database files will be stored in
      // this directory
      final String directory = haloDbConfiguration.getDatabaseDir().toString();
      ...
      // stats are snapshotted and not persistant... maybe add metrics later
